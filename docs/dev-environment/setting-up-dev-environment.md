...
After running the final apt install command, you should see a pink screen on your terminal asking you to set a password for the database. You can choose to set a password or leave it blank.
