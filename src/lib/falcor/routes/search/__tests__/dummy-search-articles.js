export const titles = [
  'The wrath of mighty potatoes',
  'Heavy is the new light',
  'There is no plan',
  'Football yay!',
  'The amazing race is not amazing',
];

export const slugs = [
  'wrath-mighty-potatoes',
  'heavy-new-light',
  'there-is-no-plan',
  'football-yay',
  'amazing-not-so-amazing-race',
];

export const markdowns = [
  `Insane. Potatoes are everywhere. I have seen more potatoes here than I have seen in my entire life. 
  ...
  `Inserting dummy text here as this place is not as realvant. However, should you ever find the need to edit this, 
  ...
  `,
  `Ah, the game of football is as interesting as ever. It is known by many and watched by many that don't know what it is they are watching. 
  ...
  `Ah. You might expect this article to be about you-know-what. But alas, you have fallen for the trick. 
  ...
  `This article is nothing about the amazing race. It is instead about the one and only Hobbit. A great hobbit once wrote code for the gazelle. 
