...
eval "mysqldump -u $userName -p$password $databaseName > $directive/helpers/temp.dump"
# printf "\ndump successful\n"
# printf "\ninitiating database backup\n"
eval "$nodePath $directive/helpers/upload-database-dump.js $directive/helpers/temp.dump"
# printf "\nbackup complete\n"
